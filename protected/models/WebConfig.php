...
class WebConfig extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('web_title, fanpage_url, secret_id, app_id, youtube_url', 'length', 'max'=>255),
			array('meta_description, meta_keyword', 'length', 'max'=>512),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, web_title, meta_description, meta_keyword, fanpage_url, secret_id, app_id, youtube_url', 'safe', 'on'=>'search'),
		);
	}
