!function(e, t) {
	...
	function m(e, t) {
		...
		if (1 === t.nodeType) {
			if (ve.hasData(e) && (o = ve.access(e), s = ve.set(t, o), u = o.events)) {
				...
				for (r in u) for (n = 0, i = u[r].length; i > n; n++) J.event.add(t, r, u[r][n])
			}
	...
	function F(e, t, n) {
		var i, r, o = 0,
			...
			c = u.props;
		for (N(c, u.opts.specialEasing); s > o; o++) if (i = tt[o].call(u, e, c, u.opts)) return i;
	...
	J.fn = J.prototype = {
		...
		var e, t, n, i, r, o, s = arguments[0] || {},
			...
			l = arguments.length,
			u = !1;
		for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || J.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++) if (null != (e = arguments[a])) for (t in e) n = s[t], i = e[t], s !== i && (u && i && (J.isPlainObject(i) || (r = J.isArray(i))) ? (r ? (r = !1, o = n && J.isArray(n) ? n : []) : o = n && J.isPlainObject(n) ? n : {}, s[t] = J.extend(u, o, i)) : void 0 !== i && (s[t] = i));
		return s
	}, J.extend({
		...
		makeArray: function(e, t) {
			var i = t || [];
			return null != e && (n(Object(e)) ? J.merge(i, "string" == typeof e ? [e] : e) : V.call(i, e)), i
		},
	...
	var re = function(e) {
		function t(e, t, n, i) {
			...
			if ((t ? t.ownerDocument || t : z) !== M && A(t), t = t || M, n = n || [], a = t.nodeType, "string" != typeof e || !e || 1 !== a && 9 !== a && 11 !== a) return n;
			if (!i && F) {
		...
		function y(e) {
			for (var t, n, i, r = e.length, o = S.relative[e[0].type], s = o || S.relative[" "], a = o ? 1 : 0, l = f(function(e) {
				...
				return t = null, r
			}]; r > a; a++) if (n = S.relative[e[a].type]) c = [f(h(c), n)];
			else {
			...
			var r = n.length > 0,
				...
				s = function(i, s, a, l, u) {
					var c, d, p, f = 0,
						...
						x = w.length;
					for (u && (O = s !== M && s); h !== x && null != (c = w[h]); h++) {
						if (o && c) {
		...
		var b, x, S, k, C, T, _, E, O, D, P, A, M, N, F, I, L, j, Y, $ = "sizzle" + 1 * new Date,
			z = e.document,
			H = 0,
			q = 0,
			W = n(),
		...
		x = t.support = {}, C = t.isXML = function(e) {
			...
			return i !== M && 9 === i.nodeType && i.documentElement ? (M = i, N = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", ke, !1) : n.attachEvent && n.attachEvent("onunload", ke)), F = !C(i), x.attributes = r(function(e) {
			...
			}, L = [], I = [], (x.qsa = ve.test(i.querySelectorAll)) && (r(function(e) {
			...
			})), (x.matchesSelector = ve.test(j = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && r(function(e) {
				x.disconnectedMatch = j.call(e, "div"), j.call(e, "[s!='']:x"), L.push("!=", se)
			}), I = I.length && new RegExp(I.join("|")), L = L.length && new RegExp(L.join("|")), t = ve.test(N.compareDocumentPosition), Y = t || ve.test(N.contains) ?
			function(e, t) {
			...
			if ((e.ownerDocument || e) !== M && A(e), n = n.replace(de, "='$1']"), x.matchesSelector && F && (!L || !L.test(n)) && (!I || !I.test(n))) try {
				var i = j.call(e, n);
			...
			var n = S.attrHandle[t.toLowerCase()],
				i = n && U.call(S.attrHandle, t.toLowerCase()) ? n(e, t, !F) : void 0;
					...
					function(e) {
						...
						if (m) {
							...
							if (h = [s ? m.firstChild : m.lastChild], s && y) {
								for (c = m[$] || (m[$] = {}), u = c[e] || [], f = u[0] === H && u[1], p = u[0] === H && u[2], d = f && m.childNodes[f]; d = ++f && d && d[g] || (p = f = 0) || h.pop();) if (1 === d.nodeType && ++p && d === t) {
									c[e] = [H, f, p];
									break
								}
		...
		return d.prototype = S.filters = S.pseudos, S.setFilters = new d, T = t.tokenize = function(e, n) {
			...
			if (n = n || [], 1 === d.length) {
				if (o = d[0] = d[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && x.getById && 9 === t.nodeType && F && S.relative[o[1].type]) {
					if (t = (S.find.ID(s.matches[0].replace(xe, Se), t) || [])[0], !t) return n;
					u && (t = t.parentNode), e = e.slice(o.shift().value.length)
				}
				for (r = he.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !S.relative[a = s.type]);) if ((l = S.find[a]) && (i = l(s.matches[0].replace(xe, Se), we.test(o[0].type) && c(t.parentNode) || t))) {
					if (o.splice(r, 1), e = i.length && p(o), !e) return K.apply(n, i), n;
					break
				}
			}
			return (u || _(e, d))(i, t, !F, n, we.test(e) && c(t.parentNode) || t), n
	...
	J.Callbacks = function(e) {
		...
		when: function(e) {
			...
			if (s > 1) for (t = new Array(s), n = new Array(s), i = new Array(s); s > r; r++) o[r] && J.isFunction(o[r].promise) ? o[r].promise().done(u(r, i, o)).fail(l.reject).progress(u(r, n, t)) : --a;
	...
	J.event = {
		...
		remove: function(e, t, n, i, r) {
			...
			if (m && (l = m.events)) {
				for (t = (t || "").match(fe) || [""], u = t.length; u--;) if (a = De.exec(t[u]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
	...
	Ye.optgroup = Ye.option, Ye.tbody = Ye.tfoot = Ye.colgroup = Ye.caption = Ye.thead, Ye.th = Ye.td, J.extend({
		clone: function(e, t, n) {
			...
			if (!(Z.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || J.isXMLDoc(e))) for (s = v(a), o = v(e), i = 0, r = o.length; r > i; i++) y(o[i], s[i]);
			if (t) if (n) for (o = o || v(e), s = s || v(a), i = 0, r = o.length; r > i; i++) m(o[i], s[i]);
			else m(e, a);
			return s = v(a, "script"), s.length > 0 && g(s, !l && v(e, "script")), a
		},
		buildFragment: function(e, t, n, i) {
			for (var r, o, s, a, l, u, c = t.createDocumentFragment(), d = [], p = 0, f = e.length; f > p; p++) if (r = e[p], r || 0 === r) if ("object" === J.type(r)) J.merge(d, r.nodeType ? [r] : r);
			else if (Me.test(r)) {
			...
			for (c.textContent = "", p = 0; r = d[p++];) if ((!i || -1 === J.inArray(r, i)) && (l = J.contains(r.ownerDocument, r), o = v(c.appendChild(r), "script"), l && g(o), n)) for (u = 0; r = o[u++];) Ie.test(r.type || "") && n.push(r);
			return c
		},
		...
		html: function(e) {
			return me(this, function(e) {
				...
				if ("string" == typeof e && !Ne.test(e) && !Ye[(Ae.exec(e) || ["", ""])[1].toLowerCase()]) {
					e = e.replace(Pe, "<$1></$2>");
					try {
		...
		domManip: function(e, t) {
			...
			var n, i, r, o, s, a, l = 0,
				...
				p = e[0],
				g = J.isFunction(p);
			if (g || u > 1 && "string" == typeof p && !Z.checkClone && Fe.test(p)) return this.each(function(n) {
				var i = c.eq(n);
			...
			if (u && (n = J.buildFragment(e, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
				...
				if (o) for (a = r[r.length - 1].ownerDocument, J.map(r, h), l = 0; o > l; l++) s = r[l], Ie.test(s.type || "") && !ve.access(s, "globalEval") && J.contains(a, s) && (s.src ? J._evalUrl && J._evalUrl(s.src) : J.globalEval(s.textContent.replace(je, "")))
			}
			return this
		}
	}), J.each({
		...
		J.fn[e] = function(e) {
			for (var n, i = [], r = J(e), o = r.length - 1, s = 0; o >= s; s++) n = s === o ? this : this.clone(!0), J(r[s])[t](n), V.apply(i, n.get());
	...
	J.extend({
		...
		J.cssHooks[t] = {
			get: function(e, n, i) {
				return n ? Re.test(J.css(e, "display")) && 0 === e.offsetWidth ? J.swap(e, Be, function() {
					return _(e, t, i)
				}) : _(e, t, i) : void 0
			},
			set: function(e, n, i) {
	...
	J.fn.extend({
		...
		toggleClass: function(e, t) {
			...
			return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : J.isFunction(e) ? this.each(function(n) {
				...
				if ("string" === n) for (var t, i = 0, r = J(this), o = e.match(fe) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
	...
	J.fn.extend({
		...
		valHooks: {
			...
			select: {
				get: function(e) {
					for (var t, n, i = e.options, r = e.selectedIndex, o = "select-one" === e.type || 0 > r, s = o ? null : [], a = o ? r + 1 : i.length, l = 0 > r ? a : o ? r : 0; a > l; l++) if (n = i[l], (n.selected || l === r) && (Z.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !J.nodeName(n.parentNode, "optgroup"))) {
	...
	J.ajaxSetup({
		...
		var r, o, s, a = t.jsonp !== !1 && (Nt.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Nt.test(t.data) && "data");
		return a || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = J.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Nt, "$1" + r) : t.jsonp !== !1 && (t.url += (ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
			return s || J.error(r + " was not called"), s[0]
		}, t.dataTypes[0] = "json", o = e[r], e[r] = function() {
			s = arguments
		}, i.always(function() {
			e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Mt.push(r)), s && J.isFunction(o) && o(s[0]), s = o = void 0
		}), "script") : void 0
	...
	var d, p, f = "2.8.3",
		...
		N = function(e, n, i, r) {
			...
			if (parseInt(i, 10)) for (; i--;) a = t.createElement("div"), a.id = r ? r[i] : v + (i + 1), u.appendChild(a);
		...
		L = {}.hasOwnProperty;
	p = o(L, "undefined") || o(L.call, "undefined") ?
	function(e, t) {
	...
	return h.input || c(), h.addTest = function(e, t) {
		...
		e.html5 = y, l(t)
	}(this, t), h._version = f, h._prefixes = k, h._domPrefixes = _, h._cssomPrefixes = T, h.mq = F, h.hasEvent = I, h.testProp = function(e) {
		return a([e])
	...
	function x(e) {
		...
		if (!Yn[e] && "undefined" != typeof module && module && module.exports) try {
			t = In._abbr, require("./locale/" + e), S(t)
		} catch (n) {}
		return Yn[e]
	}
	function S(e, t) {
		var n;
		return e && (n = "undefined" == typeof t ? C(e) : k(e, t), n && (In = n)), In._abbr
	}
	function k(e, t) {
	...
	function I(e) {
		...
		for (t = 0, n = i.length; n > t; t++) Wn[i[t]] ? i[t] = Wn[i[t]] : i[t] = F(i[t]);
		return function(r) {
			var o = "";
	...
	function L(e, t) {
		return e.isValid() ? (t = j(t, e.localeData()), qn[t] = qn[t] || I(t), qn[t](e)) : e.localeData().invalidDate()
	}
	function j(e, t) {
		function n(e) {
	...
	function K(e) {
		var t, n = e._a;
		return n && -2 === u(e).overflow && (t = n[ai] < 0 || n[ai] > 11 ? ai : n[li] < 1 || n[li] > V(n[si], n[ai]) ? li : n[ui] < 0 || n[ui] > 24 || 24 === n[ui] && (0 !== n[ci] || 0 !== n[di] || 0 !== n[pi]) ? ui : n[ci] < 0 || n[ci] > 59 ? ci : n[di] < 0 || n[di] > 59 ? di : n[pi] < 0 || n[pi] > 999 ? pi : -1, u(e)._overflowDayOfYear && (si > t || t > li) && (t = li), u(e).overflow = t), e
	}
	function J(t) {
	...
	function ne(e) {
		var t, n, i = e._i,
			r = mi.exec(i);
		if (r) {
			for (u(e).iso = !0, t = 0, n = vi.length; n > t; t++) if (vi[t][1].exec(i)) {
				e._f = vi[t][0];
				break
			}
			for (t = 0, n = yi.length; n > t; t++) if (yi[t][1].exec(i)) {
				e._f += (r[6] || " ") + yi[t][0];
				break
			}
	...
	function xe(t) {
		...
		var n, i, r, o, s, a = "" + t._i,
			l = a.length,
			c = 0;
		for (r = j(t._f, t._locale).match(zn) || [], n = 0; n < r.length; n++) o = r[n], i = (a.match(z(o, t)) || [])[0], i && (s = a.substr(0, a.indexOf(i)), s.length > 0 && u(t).unusedInput.push(s), a = a.slice(a.indexOf(i) + i.length), c += i.length), Wn[o] ? (i ? u(t).empty = !1 : u(t).unusedTokens.push(o), R(o, i, t)) : t._strict && !i && u(t).unusedTokens.push(o);
	...
	function Ie(e, t) {
		N(e, 0, 0, function() {
			var e = this.utcOffset(),
				n = "+";
			return 0 > e && (e = -e, n = "-"), n + M(~~ (e / 60), 2) + t + M(~~e % 60, 2)
		})
	}
	function Le(e) {
		var t = (e || "").match(ti) || [],
	...
	function Ze(e, t) {
		...
		return Fe(e) ? s = {
			...
			s: Qe(a[7], n),
			w: Qe(a[8], n)
		}) : null == s ? s = {} : "object" == typeof s && ("from" in s || "to" in s) && (r = Je(De(s.from), De(s.to)), s = {}, s.ms = r.milliseconds, s.M = r.months), i = new Ne(s), Fe(e) && o(e, "_locale") && (i._locale = e._locale), i
	}
	function Qe(e, t) {
	...
	function zt(e) {
		var t, n, i;
		for (this._weekdaysParse = this._weekdaysParse || [], t = 0; 7 > t; t++) if (this._weekdaysParse[t] || (n = De([2e3, 1]).day(t), i = "^" + this.weekdays(n, "") + "|^" + this.weekdaysShort(n, "") + "|^" + this.weekdaysMin(n, ""), this._weekdaysParse[t] = new RegExp(i.replace(".", ""), "i")), this._weekdaysParse[t].test(e)) return t
	}
	function Ht(e) {
	...
	var Fn, In, Ln = e.momentProperties = [],
		jn = !1,
		Yn = {},
		$n = {},
	...
	}), T("month", "M"), $("M", Gn), $("MM", Gn, Vn), $("MMM", ii), $("MMMM", ii), q(["M", "MM"], function(e, t) {
		t[ai] = m(e) - 1
	...
	}), N(0, ["YYYY", 4], 0, "year"), N(0, ["YYYYY", 5], 0, "year"), N(0, ["YYYYYY", 6, !0], 0, "year"), T("year", "y"), $("Y", ei), $("YY", Gn, Vn), $("YYYY", Qn, Bn), $("YYYYY", Kn, Un), $("YYYYYY", Kn, Un), q(["YYYYY", "YYYYYY"], si), q("YYYY", function(t, n) {
	...
	var bi = O("FullYear", !1);
	N("w", ["ww", 2], "wo", "week"), N("W", ["WW", 2], "Wo", "isoWeek"), T("week", "w"), T("isoWeek", "W"), $("w", Gn), $("ww", Gn, Vn), $("W", Gn), $("WW", Gn, Vn), W(["w", "ww", "W", "WW"], function(e, t, n, i) {
		t[i.substr(0, 1)] = m(e)
	});
	var xi = {
		dow: 0,
	...
	N("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), T("dayOfYear", "DDD"), $("DDD", Zn), $("DDDD", Xn), q(["DDD", "DDDD"], function(e, t, n) {
		n._dayOfYear = m(e)
	}), e.ISO_8601 = function() {};
	...
	Ie("Z", ":"), Ie("ZZ", ""), $("Z", ti), $("ZZ", ti), q(["Z", "ZZ"], function(e, t, n) {
	...
	}), Dt("gggg", "weekYear"), Dt("ggggg", "weekYear"), Dt("GGGG", "isoWeekYear"), Dt("GGGGG", "isoWeekYear"), T("weekYear", "gg"), T("isoWeekYear", "GG"), $("G", ei), $("g", ei), $("GG", Gn, Vn), $("gg", Gn, Vn), $("GGGG", Qn, Bn), $("gggg", Qn, Bn), $("GGGGG", Kn, Un), $("ggggg", Kn, Un), W(["gggg", "ggggg", "GGGG", "GGGGG"], function(e, t, n, i) {
		t[i.substr(0, 2)] = m(e)
	}), W(["gg", "GG"], function(t, n, i, r) {
		n[r] = e.parseTwoDigitYear(t)
	}), N("Q", 0, 0, "quarter"), T("quarter", "Q"), $("Q", Rn), q("Q", function(e, t) {
		t[ai] = 3 * (m(e) - 1)
	}), N("D", ["DD", 2], "Do", "date"), T("date", "D"), $("D", Gn), $("DD", Gn, Vn), $("Do", function(e, t) {
	...
	}), N("e", 0, 0, "weekday"), N("E", 0, 0, "isoWeekday"), T("day", "d"), T("weekday", "e"), T("isoWeekday", "E"), $("d", Gn), $("e", Gn), $("E", Gn), $("dd", ii), $("ddd", ii), $("dddd", ii), W(["dd", "ddd", "dddd"], function(e, t, n) {
	...
	var Ai = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
		...
		Ni = "Su_Mo_Tu_We_Th_Fr_Sa".split("_");
	N("H", ["HH", 2], 0, "hour"), N("h", ["hh", 2], 0, function() {
		return this.hours() % 12 || 12
	}), Rt("a", !0), Rt("A", !1), T("hour", "h"), $("a", Vt), $("A", Vt), $("H", Gn), $("h", Gn), $("HH", Gn, Vn), $("hh", Gn, Vn), q(["H", "HH"], ui), q(["a", "A"], function(e, t, n) {
	...
	var Fi = /[ap]\.?m?\.?/i,
		Ii = O("Hours", !0);
	N("m", ["mm", 2], 0, "minute"), T("minute", "m"), $("m", Gn), $("mm", Gn, Vn), q(["m", "mm"], ci);
	var Li = O("Minutes", !1);
	N("s", ["ss", 2], 0, "second"), T("second", "s"), $("s", Gn), $("ss", Gn, Vn), q(["s", "ss"], di);
	var ji = O("Seconds", !1);
	N("S", 0, 0, function() {
	...
	}), T("millisecond", "ms"), $("S", Zn, Rn), $("SS", Zn, Vn), $("SSS", Zn, Xn);
	var Yi;
	...
	if (!e.jQuery) {
		...
		function(e) {
			...
			if (i) {
				...
				for (o in e) if (r = n.apply(e[o], i), r === !1) break
			} else if (a) for (; s > o && (r = n.call(e[o], o, e[o]), r !== !1); o++);
			else
			for (o in e) if (r = n.call(e[o], o, e[o]), r === !1) break;
			return e
			...
			var e, t, i, r, o, s, a = arguments[0] || {},
				...
				u = arguments.length,
				c = !1;
			for ("boolean" == typeof a && (c = a, a = arguments[l] || {}, l++), "object" != typeof a && "function" !== n.type(a) && (a = {}), l === u && (a = this, l--); u > l; l++) if (null != (o = arguments[l])) for (r in o) e = a[r], i = o[r], a !== i && (c && i && (n.isPlainObject(i) || (t = n.isArray(i))) ? (t ? (t = !1, s = e && n.isArray(e) ? e : []) : s = e && n.isPlainObject(e) ? e : {}, a[r] = n.extend(c, s, i)) : void 0 !== i && (a[r] = i));
			return a
	...
	return function(e, t, n, i) {
		...
		function c(e) {
			if (e) {
				...
				for (var o = 0; n > o; o++) if (w.State.calls[o]) {
						...
						if (s(C)) {
							...
							for (var E in S) if ("element" !== E) {
								...
								if (D.currentValue = O, "tween" === E) m = O;
									...
									var F = x.setPropertyValue(C, E, D.currentValue + (0 === parseFloat(O) ? "" : D.unitType), D.rootPropertyValue, D.scrollData);
									x.Hooks.registered[E] && (x.Normalizations.registered[M] ? s(C).rootPropertyValueCache[M] = x.Normalizations.registered[M]("extract", null, F[1]) : s(C).rootPropertyValueCache[M] = F[1]), "transform" === F[0] && (T = !0)
								}
							}
		...
		function d(e, t) {
			...
			w.State.calls[e] = !1;
			for (var g = 0, m = w.State.calls.length; m > g; g++) if (w.State.calls[g] !== !1) {
				l = !0;
				break
			}
		...
		var b = function() {
			...
			return function i(e, t, r) {
				var o, s, a, l = {
					...
					d = 1e-4,
					p = .016;
				for (e = parseFloat(e) || 500, t = parseFloat(t) || 20, r = r || null, l.tension = e, l.friction = t, o = null !== r, o ? (c = i(e, t), s = c / r * p) : s = p;;) if (a = n(a || l, s), u.push(1 + a.x), c += 16, !(Math.abs(a.x) > d && Math.abs(a.v) > d)) break;
				return o ?
				function(e) {
		...
		var x = w.CSS = {
			...
			getPropertyValue: function(e, n, r, o) {
				...
				if (!/^[\d-]/.test(l)) if (s(e) && s(e).isSVG && x.Names.SVGAttribute(n)) if (/^(height|width)$/i.test(n)) try {
					l = e.getBBox()[n]
				} catch (g) {
					l = 0
		...
		var S = function() {
				...
				function e(e) {
					...
					function v() {
						var e = {
							...
							i = e.position === F.lastPosition && e.myParent === F.lastParent,
							r = e.fontSize === F.lastFontSize;
						F.lastParent = e.myParent, F.lastPosition = e.position, F.lastFontSize = e.fontSize;
						var a = 100,
							l = {};
						if (r && i) l.emToPx = F.lastEmToPx, l.percentToPxWidth = F.lastPercentToPxWidth, l.percentToPxHeight = F.lastPercentToPxHeight;
						else {
							...
							}), w.CSS.setPropertyValue(u, "paddingLeft", a + "em"), l.percentToPxWidth = F.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(u, "width", null, !0)) || 1) / a, l.percentToPxHeight = F.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(u, "height", null, !0)) || 1) / a, l.emToPx = F.lastEmToPx = (parseFloat(x.getPropertyValue(u, "paddingLeft")) || 1) / a, e.myParent.removeChild(u)
						}
						return null === F.remToPx && (F.remToPx = parseFloat(x.getPropertyValue(n.body, "fontSize")) || 16), null === F.vwToPx && (F.vwToPx = parseFloat(t.innerWidth) / 100, F.vhToPx = parseFloat(t.innerHeight) / 100), l.remToPx = F.remToPx, l.vwToPx = F.vwToPx, l.vhToPx = F.vhToPx, w.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), o), l
					}
					if (a.begin && 0 === C) try {
						a.begin.call(h, h)
					} catch (b) {
					...
					if ("scroll" === O) {
						...
						for (var M in A) if ("element" !== M) {
							var N = A[M].startValue;
							A[M].startValue = A[M].currentValue = A[M].endValue, A[M].endValue = N, g.isEmptyObject(y) || (A[M].easing = a.easing), w.debug && console.log("reverse tweensContainer (" + M + "): " + JSON.stringify(A[M]), o)
						}
						l = A
					} else if ("start" === O) {
						var A;
						...
						for (var L in m) {
							...
							if (s(o).isSVG || "tween" === H || x.Names.prefixCheck(H)[1] !== !1 || x.Normalizations.registered[H] !== i) {
								...
								var W, R, V, X = !1;
								if (W = f(L, z), z = W[0], V = W[1], W = f(L, Y), Y = W[0].replace(/^([+-\/*])=/, function(e, t) {
									return X = t, ""
								}), R = W[1], z = parseFloat(z) || 0, Y = parseFloat(Y) || 0, "%" === R && (/^(fontSize|lineHeight)$/.test(L) ? (Y /= 100, R = "em") : /^scale/.test(L) ? (Y /= 100, R = "") : /(Red|Green|Blue)$/i.test(L) && (Y = Y / 100 * 255, R = "")), /[\/*]/.test(X)) R = V;
								else if (V !== R && 0 !== z) if (0 === Y) R = V;
								else {
									r = r || v();
					...
					l.element && (x.Values.addClass(o, "velocity-animating"), I.push(l), "" === a.queue && (s(o).tweensContainer = l, s(o).opts = a), s(o).isAnimating = !0, C === k - 1 ? (w.State.calls.push([I, h, a, null, E.resolver]), w.State.isTicking === !1 && (w.State.isTicking = !0, c())) : C++)
				}
				var r, o = this,
			...
			if (g.isWrapped(this) ? (a = !1, f = 0, h = this, l = this) : (a = !0, f = 1, h = b ? arguments[0].elements || arguments[0].e : arguments[0]), h = o(h)) {
					...
					if (!p.isPlainObject(m) || g.isEmptyObject(m)) {
						if (g.isString(m) && w.Redirects[m]) {
							...
							return P.backwards === !0 && (h = p.extend(!0, [], h).reverse()), p.each(h, function(e, t) {
								parseFloat(P.stagger) ? P.delay = M + parseFloat(P.stagger) * e : g.isFunction(P.stagger) && (P.delay = M + P.stagger.call(t, e, k)), P.drag && (P.duration = parseFloat(A) || (/^(callout|transition)/.test(m) ? 1e3 : v), P.duration = Math.max(P.duration * (P.backwards ? 1 - e / k : (e + 1) / k), .75 * P.duration, 200)), w.Redirects[m].call(t, t, P || {}, e, k, h, E.promise ? E : i)
							}), e()
						}
						var N = "Velocity: First argument (" + m + ") was not a property map, a known action, or a registered redirect. Aborting.";
						return E.promise ? E.rejecter(new Error(N)) : console.log(N), e()
					}
					O = "start"
				}
				var F = {
				...
				if (P.loop = parseInt(P.loop), L = 2 * P.loop - 1, P.loop) for (var j = 0; L > j; j++) {
					var Y = {
						delay: P.delay,
						progress: P.progress
					};
			...
			return o.Redirects[e] = function(r, a, l, u, c, d) {
				...
				for (var h = 0; h < t.calls.length; h++) {
					...
					if (b.duration = v * (y || 1), b.queue = a.queue || "", b.easing = w.easing || "ease", b.delay = parseFloat(w.delay) || 0, b._cacheValues = w._cacheValues || !0, 0 === h) {
						...
						}), null !== a.display) if (a.display !== i && "none" !== a.display) b.display = a.display;
						else if (/In$/.test(e)) {
	...
	e.prototype.tokenize = function(e) {
		...
		for (t = 0, n = u.length; n > t; t++) {
			if (o = r(u[t]), this.settings.diacritics) for (a in s) s.hasOwnProperty(a) && (o = o.replace(new RegExp(a, "g"), s[a]));
			l.push({
				string: u[t],
		...
		}, a = [], f) for (i = 0, r = f.length; r > i; i++)(e.query || "$score" !== f[i].field) && a.push(f[i]);
		if (e.query) {
			for (p = !0, i = 0, r = a.length; r > i; i++) if ("$score" === a[i].field) {
				p = !1;
				break
			}
			p && a.unshift({
		...
		for (i = 0, r = a.length; r > i; i++) if ("$score" === a[i].field) {
			a.splice(i, 1);
			break
		}
		...
		return l = a.length, l ? 1 === l ? (s = a[0].field, u = c[0], function(e, n) {
			...
			var i, r, o;
			for (i = 0; l > i; i++) if (o = a[i].field, r = c[i] * t(d(o, e), d(o, n))) return r;
			return 0
		} : null
	...
	var t = function(e, t) {
		...
		n = function(e, t) {
			var n, i, r, o;
			for (n = 1, i = arguments.length; i > n; n++) if (o = arguments[n]) for (r in o) o.hasOwnProperty(r) && (e[r] = o[r]);
			return e
		},
		i = function(e) {
		...
		a = function() {
			var e, t, n, i, r = "",
				o = {};
			for (n in s) if (s.hasOwnProperty(n)) for (i = s[n].substring(2, s[n].length - 1), r += i, e = 0, t = i.length; t > e; e++) o[i.charAt(e)] = n;
	...
	e.mixin = function(e) {
		e.plugins = {}, e.prototype.initializePlugins = function(e) {
			...
			if (o.plugins = {
				...
				requested: {},
				loaded: {}
			}, t.isArray(e)) for (n = 0, i = e.length; i > n; n++)"string" == typeof e[n] ? s.push(e[n]) : (o.plugins.settings[e[n].name] = e[n].options, s.push(e[n].name));
			else if (e) for (r in e) e.hasOwnProperty(r) && (o.plugins.settings[r] = e[r], s.push(r));
	...
	return r.mixin(j), n.mixin(j), e.extend(j.prototype, {
		...
		search: function(t) {
			...
			if (t !== o.lastQuery ? (o.lastQuery = t, i = o.sifter.search(t, e.extend(a, {
				score: r
			})), o.currentResults = i) : i = e.extend(!0, {}, o.currentResults), s.hideSelected) for (n = i.items.length - 1; n >= 0; n--) - 1 !== o.items.indexOf(T(i.items[n].id)) && i.items.splice(n, 1);
			return i
		},
		refreshOptions: function(t) {
			...
			for (s = x.items.length, "number" == typeof w.settings.maxOptions && (s = Math.min(s, w.settings.maxOptions)), a = {}, l = [], n = 0; s > n; n++) for (u = w.options[x.items[n].id], c = w.render("option", u), d = u[w.settings.optgroupField] || "", p = e.isArray(d) ? d : [d], r = 0, o = p && p.length; o > r; r++) d = p[r], w.optgroups.hasOwnProperty(d) || (d = ""), a.hasOwnProperty(d) || (a[d] = [], l.push(d)), a[d].push(c);
			...
			if (S.html(f.join("")), w.settings.highlight && x.query.length && x.tokens.length) for (n = 0, s = x.tokens.length; s > n; n++) i(S, x.tokens[n].regex);
			if (!w.settings.hideSelected) for (n = 0, s = w.items.length; s > n; n++) w.getOption(w.items[n]).addClass("selected");
		...
		addOption: function(t) {
			var n, i, r, o = this;
			if (e.isArray(t)) for (n = 0, i = t.length; i > n; n++) o.addOption(t[n]);
		...
		getElementWithValue: function(t, n) {
			if (t = T(t), "undefined" != typeof t && null !== t) for (var i = 0, r = n.length; r > i; i++) if (n[i].getAttribute("data-value") === t) return e(n[i]);
			return e()
		},
		getItem: function(e) {
		...
		deleteSelection: function(t) {
			...
			if (r = t && t.keyCode === g ? -1 : 1, o = N(d.$control_input[0]), d.$activeOption && !d.settings.hideSelected && (l = d.getAdjacentOption(d.$activeOption, -1).attr("data-value")), s = [], d.$activeItems.length) {
		...
		advanceSelection: function(e, t) {
			...
			0 !== e && (l.rtl && (e *= -1), n = e > 0 ? "last" : "first", i = N(l.$control_input[0]), l.isFocused && !l.isInputHidden ? (o = l.$control_input.val().length, s = 0 > e ? 0 === i.start && 0 === i.length : i.start === o, s && !o && l.advanceCaret(e, t)) : (a = l.$control.children(".active:" + n), a.length && (r = l.$control.children(":not(input)").index(a), l.setActiveItem(null), l.setCaret(e > 0 ? r + 1 : r))))
		},
		...
		var n = e.fn.selectize.defaults,
			...
			c = function(t, n) {
				...
				if (d) for (n.options = JSON.parse(d), a = 0, l = n.options.length; l > a; a++) n.items.push(n.options[a][s]);
				else {
					var p = e.trim(t.val() || "");
		...
		var e = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
			t = _self.Prism = {
				...
				languages: {
					...
					insertBefore: function(e, n, i, r) {
						...
						for (var l in o) if (o.hasOwnProperty(l)) {
							if (l == n) for (var s in i) i.hasOwnProperty(s) && (a[s] = i[s]);
							a[l] = o[l]
						}
				...
				tokenize: function(e, n, i) {
					...
					e: for (var a in n) if (n.hasOwnProperty(a) && n[a]) {
						var l = n[a];
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
	...
	function T(e) {
		...
		return new(t = n ? n : ve ? $ : ye ? q : me ? R : Y)(e, _)
	}
	function _(e, t, n) {
		var i = n.pointers.length,
			...
			o = t & Ce && i - r === 0,
			s = t & (_e | Ee) && i - r === 0;
		n.isFirst = !! o, n.isFinal = !! s, o && (e.session = {}), n.eventType = t, E(e, n), e.emit("hammer.input", n), e.recognize(n), e.session.prevInput = n
	}
	function E(e, t) {
		var n = e.session,
			i = t.pointers,
		...
		var o = n.firstInput,
			...
			l = t.center = A(i);
		t.timeStamp = fe(), t.deltaTime = t.timeStamp - o.timeStamp, t.angle = I(a, l), t.distance = F(a, l), O(n, t), t.offsetDirection = N(t.deltaX, t.deltaY), t.scale = s ? j(s.pointers, i) : 1, t.rotation = s ? L(s.pointers, i) : 0, D(n, t);
		var u = e.element;
	...
	function O(e, t) {
		var n = t.center,
			...
			r = e.prevDelta || {},
			o = e.prevInput || {};
		(t.eventType === Ce || o.eventType === _e) && (r = e.prevDelta = {
			x: o.deltaX || 0,
			y: o.deltaY || 0
		}, i = e.offsetDelta = {
			x: n.x,
	...
	function D(e, t) {
		...
		if (t.eventType != Ee && (l > ke || a.velocity === i)) {
			var u = a.deltaX - t.deltaX,
				c = a.deltaY - t.deltaY,
				d = M(l, u, c);
	...
	function N(e, t) {
		return e === t ? Oe : pe(e) >= pe(t) ? e > 0 ? De : Pe : t > 0 ? Ae : Me
	}
	function F(e, t, n) {
		n || (n = Le);
		var i = t[n[0]] - e[n[0]],
	...
	function L(e, t) {
		return I(t[1], t[0], je) - I(e[1], e[0], je)
	}
	function j(e, t) {
		return F(t[0], t[1], je) / F(e[0], e[1], je)
	}
	function Y() {
		this.evEl = $e, this.evWin = ze, this.allow = !0, this.pressed = !1, C.apply(this, arguments)
	}
	function $() {
		this.evEl = We, this.evWin = Re, C.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
	}
	function z() {
		this.evTarget = Xe, this.evWin = Be, this.started = !1, C.apply(this, arguments)
	}
	function H(e, t) {
		var n = w(e.touches),
			i = w(e.changedTouches);
		return t & (_e | Ee) && (n = b(n.concat(i), "identifier", !0)), [n, i]
	}
	function q() {
		this.evTarget = Ge, this.targetIds = {}, C.apply(this, arguments)
	}
	function W(e, t) {
		var n = w(e.touches),
			i = this.targetIds;
		if (t & (Ce | Te) && 1 === n.length) return i[n[0].identifier] = !0, [n, n];
		var r, o, s = w(e.changedTouches),
			a = [],
			l = this.target;
		if (o = n.filter(function(e) {
			return g(e.target, l)
		}), t === Ce) for (r = 0; r < o.length;) i[o[r].identifier] = !0, r++;
		for (r = 0; r < s.length;) i[s[r].identifier] && a.push(s[r]), t & (_e | Ee) && delete i[s[r].identifier], r++;
		return a.length ? [b(o.concat(a), "identifier", !0), a] : void 0
	}
	function R() {
		C.apply(this, arguments);
		var e = c(this.handler, this);
		this.touch = new q(this.manager, e), this.mouse = new Y(this.manager, e)
	}
	function V(e, t) {
	...
	function X(e) {
		...
		var t = m(e, nt),
			n = m(e, it);
		return t && n ? nt + " " + it : t || n ? t ? nt : it : m(e, et) ? et : Je
	}
	function B(e) {
		this.id = S(), this.manager = null, this.options = l(e || {}, this.defaults), this.options.enable = p(this.options.enable, !0), this.state = rt, this.simultaneous = {}, this.requireFail = []
	}
	function U(e) {
		return e & ut ? "cancel" : e & at ? "end" : e & st ? "move" : e & ot ? "start" : ""
	}
	function G(e) {
		return e == Me ? "down" : e == Ae ? "up" : e == De ? "left" : e == Pe ? "right" : ""
	}
	function Z(e, t) {
		var n = t.manager;
		return n ? n.get(e) : e
	...
	function re(e, t) {
		return t = t || {}, t.recognizers = p(t.recognizers, re.defaults.preset), new oe(e, t)
	}
	function oe(e, t) {
		t = t || {}, this.options = l(t, re.defaults), this.options.inputTarget = this.options.inputTarget || e, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = e, this.input = T(this), this.touchAction = new V(this, this.options.touchAction), se(this, !0), s(t.recognizers, function(e) {
	...
	u(Y, C, {
		handler: function(e) {
			var t = Ye[e.type];
			t & Ce && 0 === e.button && (this.pressed = !0), t & Te && 1 !== e.which && (t = _e), this.pressed && this.allow && (t & _e && (this.pressed = !1), this.callback(this.manager, t, {
				pointers: [e],
				changedPointers: [e],
				pointerType: xe,
				srcEvent: e
	...
	e.MSPointerEvent && (We = "MSPointerDown", Re = "MSPointerMove MSPointerUp MSPointerCancel"), u($, C, {
		handler: function(e) {
			var t = this.store,
				n = !1,
			...
			r & Ce && (0 === e.button || s) ? 0 > a && (t.push(e), a = t.length - 1) : r & (_e | Ee) && (n = !0), 0 > a || (t[a] = e, this.callback(this.manager, r, {
				pointers: t,
				changedPointers: [e],
				pointerType: o,
				srcEvent: e
	...
	V.prototype = {
		set: function(e) {
			e == Ke && (e = this.compute()), Qe && (this.manager.element.style[Ze] = e), this.actions = e.toLowerCase().trim()
		},
		update: function() {
		...
		preventDefaults: function(e) {
			if (!Qe) {
				...
				var i = this.actions,
					...
					o = m(i, it),
					s = m(i, nt);
				return r || o && n & Ne || s && n & Fe ? this.preventSrc(t) : void 0
			}
		},
	...
	B.prototype = {
		...
		recognize: function(e) {
			var t = a({}, e);
			return d(this.options.enable, [this, t]) ? (this.state & (lt | ut | ct) && (this.state = rt), this.state = this.process(t), void(this.state & (ot | st | at | ut) && this.tryEmit(t))) : (this.reset(), void(this.state = ct))
		},
		process: function(e) {},
		...
		process: function(e) {
			var t = this.state,
				...
				i = t & (ot | st),
				r = this.attrTest(e);
			return i && (n & Ee || !r) ? t | ut : i || r ? n & _e ? t | at : t & ot ? t | st : ot : ct
		}
	}), u(K, Q, {
		defaults: {
			event: "pan",
		...
		getTouchAction: function() {
			var e = this.options.direction,
				t = [];
			return e & Ne && t.push(it), e & Fe && t.push(nt), t
		},
		directionTest: function(e) {
			var t = this.options,
				...
				o = e.deltaX,
				s = e.deltaY;
			return r & t.direction || (t.direction & Ne ? (r = 0 === o ? Oe : 0 > o ? De : Pe, n = o != this.pX, i = Math.abs(e.deltaX)) : (r = 0 === s ? Oe : 0 > s ? Ae : Me, n = s != this.pY, i = Math.abs(e.deltaY))), e.direction = r, n && i > t.threshold && r & t.direction
		},
		attrTest: function(e) {
			return Q.prototype.attrTest.call(this, e) && (this.state & ot || !(this.state & ot) && this.directionTest(e))
		},
		emit: function(e) {
		...
		process: function(e) {
			...
			if (this._input = e, !i || !n || e.eventType & (_e | Ee) && !o) this.reset();
			else if (e.eventType & Ce) this.reset(), this._timer = r(function() {
				this.state = lt, this.tryEmit()
			}, t.time, this);
			else if (e.eventType & _e) return lt;
			return ct
		},
		reset: function() {
		...
		emit: function(e) {
			this.state === lt && (e && e.eventType & _e ? this.manager.emit(this.options.event + "up", e) : (this._input.timeStamp = fe(), this.manager.emit(this.options.event, this._input)))
		}
	}), u(te, Q, {
		defaults: {
			event: "rotate",
		...
		attrTest: function(e) {
			...
			return n & (Ne | Fe) ? t = e.velocity : n & Ne ? t = e.velocityX : n & Fe && (t = e.velocityY), this._super.attrTest.call(this, e) && n & e.direction && e.distance > this.options.threshold && pe(t) > this.options.velocity && e.eventType & _e
		},
		emit: function(e) {
			var t = G(e.direction);
	...
	oe.prototype = {
		...
		recognize: function(e) {
			...
			if (!t.stopped) {
				...
				for (var o = 0; o < i.length;) n = i[o], t.stopped === pt || r && n != r && !n.canRecognizeWith(r) ? n.reset() : n.recognize(e), !r && n.state & (ot | st | at) && (r = t.curRecognizer = n), o++
			}
		},
		get: function(e) {
	...
	var e = "undefined" != typeof module && module.exports,
		...
		n = function() {
			...
			], i = 0, r = n.length, o = {}; r > i; i++) if (e = n[i], e && e[1] in document) {
