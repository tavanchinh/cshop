                ...
                editor.widgets.add('oembed', {
                    ...
                    init: function() {
                        var data = {
                            ...
                            maxWidth: this.element.data('maxWidth') || 720,
                            maxHeight: this.element.data('maxHeight') || 405,
                                                ...
                                                children: [
                                                    {
                                                        ...
                                                        width: '100px',
                                                        id: 'maxWidth',
                                                        'default': editor.config.oembed_maxWidth != null ? editor.config.oembed_maxWidth : '720',
